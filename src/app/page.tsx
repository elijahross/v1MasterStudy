        ...
        return (
            <main className="flex flex-col w-full h-full items-center justify-center">
                ...
                <div className="flex flex-col items-center justify-center mb-20">
                    <h1 className="text-4xl font-bold sm:text-start text-center mb-4">Welcome to the LivingRoom</h1>
                ...
                <div className="flex md:flex-row flex-col justify-between w-full">
                    <div className="w-full flex flex-col items-center sm:px-8 px-2 mb-20">
                        ...
                        <p>This is a research project for graduation thesis. The main goals is to evaluate the capabiliites of ai-based support systems.
                            <br/><br/> The LivingRoom is an innovative mental health chat agent that provides a natural conversation to help users reflect on their day-to-day experiences. Designed with empathy and understanding, LivingRoom creates a safe and non-judgmental space for individuals to share their thoughts, emotions, and personal stories.
                        </p>
                    </div>
                    <div className="flex flex-col items-center w-full sm:px-8 px-2 mb-20">
                        ...
                        <br/><br/>Participation in the LivingRoom project requires a commitment to open and honest dialogue. The study calls for a conversation lasting at least 5 minutes. After this interaction, participants must complete a short survey consisting of 25 questions to provide feedback crucial for the research.
                        </p>
                    </div>
                </div>
                <Footer />
