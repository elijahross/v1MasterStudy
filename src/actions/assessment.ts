...
export async function setAssessmentValues(formData: FormData) {
    ...
    const data = await client.execute(`UPDATE Account SET qa1='${fd.qa1}', qa2='${fd.qa2}', qa3='${fd.qa3}', qa4='${fd.qa4}', qa5='${fd.qa5}', qa6='${fd.qa6}', qa7='${fd.qa7}', qa8='${fd.qa8}', qa9='${fd.qa9}', qa10='${fd.qa10}', qa11='${fd.qa11}', qa12='${fd.qa12}', qa13='${fd.qa13}', qa14='${fd.qa14}', qa15='${fd.qa15}', qa16='${fd.qa16}', qa17='${fd.qa17}', qa18='${fd.qa18}', qa19='${fd.qa19}', qa20='${fd.qa20}', qa21='${fd.qa21}', qa22='${fd.qa22}', qa23='${fd.qa23}', qa24='${fd.qa24}', qa25='${fd.qa25}', qa26='${fd.qa26}', qa27='${fd.qa27}', qa28='${fd.qa28}', qa29='${fd.qa29}', qa30='${fd.qa30}', qa31='${fd.qa31}', qa32='${fd.qa32}', qa33='${fd.qa33}', qa34='${fd.qa34}', qa35='${fd.qa35}', qa36='${fd.qa36}', qa37='${fd.qa37}', qa38='${fd.qa38}', qa39='${fd.qa39}', qa40='${fd.qa40}', qa41='${fd.qa41}', qa42='${fd.qa42}', qa43='${fd.qa43}', qa44='${fd.qa44}', qa45='${fd.qa45}', qa46='${fd.qa46}', qa47='${fd.qa47}', qa48='${fd.qa48}', qa49='${fd.qa49}', qa50='${fd.qa50}', qa51='${fd.qa51}', qa52='${fd.qa52}', qa53='${fd.qa53}', qa54='${fd.qa54}', qa55='${fd.qa55}' WHERE userId='${userId}'`
